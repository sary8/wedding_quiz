...
export function NotFoundPage() {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-blush px-6 text-center">
      <h1 className="font-script text-8xl text-primary mb-2">404</h1>
      ...
      <button
        ...
        className="px-8 py-4 rounded-xl bg-primary text-white text-base font-bold hover:opacity-90 transition-opacity duration-200 min-h-[44px] shadow-[0_4px_16px_rgba(107,143,113,0.3)] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
      >
        トップへ戻る
      </button>
    </div>
